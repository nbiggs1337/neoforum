-- Drop the reports table if it exists and recreate it with correct structure
DROP TABLE IF EXISTS reports CASCADE;

-- Create reports table with correct column names
...
CREATE UNIQUE INDEX idx_reports_unique_user_post 
ON reports(post_id, reporter_id);

-- Enable RLS
ALTER TABLE reports ENABLE ROW LEVEL SECURITY;

-- RLS Policies (using 'role' column instead of 'is_admin')
