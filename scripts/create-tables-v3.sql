...
-- Forum members table with role column
...
CREATE INDEX idx_forum_members_forum ON public.forum_members(forum_id);
CREATE INDEX idx_forum_members_user ON public.forum_members(user_id);
CREATE INDEX idx_forum_members_role ON public.forum_members(role);
...
CREATE INDEX idx_user_bans_forum ON public.user_bans(forum_id);
