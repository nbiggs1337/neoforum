...
import { Zap, HelpCircle, Mail, Search, ChevronDown, ChevronRight, Book, Users, Shield, Settings, Bug, CreditCard, CheckCircle, AlertCircle } from 'lucide-react'
...
const handleContactSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (result.success) {
      setSubmitStatus({ type: 'success', message: result.message || 'Support message submitted successfully!' })
      setContactForm({ name: "", email: "", subject: "", category: "", message: "" })
    } else {
      setSubmitStatus({ type: 'error', message: result.error || 'Failed to submit support message' })
    }
  } catch (error) {
              ...
              <CardContent>
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-black font-semibold disabled:opacity-50"
                  >
